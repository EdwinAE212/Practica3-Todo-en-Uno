...
router.get("/", async (req, res) => { 
    try {
        ...
        const total = await PersonajeServ.Contar(search);
        const lista = await PersonajeServ.ListaTodos(page, limit, search);
        const totalGeneral = await PersonajeServ.Contar("");
